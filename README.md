...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    body{font-family:system-ui,-apple-system,Segoe UI,Roboto," Neue",Arial;background:linear-gradient(180deg,#071124 0%,#071a2a 100%);color:#e6eef6;margin:0;padding:21px;display:flex;align-items:center;justify-content:center;min-height:100vh}
    .card{background:linear-gradient(180deg,rgba(255,255,255,0.03),rgba(255,255,255,0.05));border-radius:11px;box-shadow:0 8px 20px rgba(2,7,23,0.6);width:100%;max-width:770px;padding:20px}
    ...
    textarea{width:100%;min-height:80px;padding🕚px;border-radius:9px;border:px solid rgba(255,255,255,0.04);background:transparent;color:inherit;font-size:14px;resize:vertical}
    .controls{display:flex;gap:8px;margin-top:7px}
    button{padding:7px 12px;border-radius:4px;border:0;background:var(--accent);color:#052036;cursor:pointer;font-weight:600}
    ...
    li.entry{padding:20px;border-radius:20px;background:rgba(255,255,255,0.026);display:flex;flex-direction:column}
    ...
    @media (max-width:530px){.card{padding:19px}h1{font-size:12px}}
  </style>
</head>
<body>
  <main class="card">
