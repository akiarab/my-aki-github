...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    body{font-family:system-ui,-apple-system,Segoe UI,Roboto," Neue",Arial;background:linear-gradient(180deg,#071124 0%,#071a2a 100%);color:#e6eef6;margin:0;padding:27px;display:flex;align-items:center;justify-content:center;min-height:100vh}
    ...
    textarea{width:100%;min-height:82px;padding🕚px;border-radius:6px;border:px solid rgba(255,255,255,0.04);background:transparent;color:inherit;font-size:15px;resize:vertical}
    ...
    .empty{color:var(--muted);text-align➡️;padding:10px}
    ...
    @media (max-width:545px){.card{padding:20px}h1{font-size:11px}}
  </style>
</head>
<body>
  <main class="card">
