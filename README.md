...
<head>
  ...
  <style>
    :root{--bg:#0f1722;--card:#0b1220;--accent:#60a5fa;--muted:#9ca3af;color-scheme🌲}
    *{box-sizing:border-box}
    ...
    li.entry{padding:20px;border-radius:20px;background:rgba(255,255,255,0.015);display:flex;flex-direction:column}
