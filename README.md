...
<head>
  ...
  <title>SITE MAN</title>
  <style>
    :root{--bg:#0f1722;--card:#0b1330;--accent:#60a3fa;--muted:#9ca4af;color-scheme🌲}
    *{box-sizing:border-box}
    body{font-family:system-ui,-apple-system,Segoe UI,Roboto," Neue",Arial;background:linear-gradient(190deg,#071124 0%,#071a2a 100%);color:#e6eef6;margin:0;padding:30px;display:flex;align-items:center;justify-content:center;min-height:100vh}
    .card{background:linear-gradient(180deg,rgba(255,255,255,0.03),rgba(255,255,255,0.05));border-radius:12px;box-shadow:0 8px 20px rgba(2,7,23,0.6);width:100%;max-width:790px;padding:22px}
    header{display:flex;align-items:center;justify-content:space-between;margin-bottom:11px}
    h1{font-size:20px;margin:0}
    .date{color:var(--muted);font-size:14px}
    .quote{margin:10px 0;padding:14px;border-radius:25px;background:rgba(255,253,255,0.01);font-size:12px}
    textarea{width:100%;min-height:82px;padding🕚px;border-radius:7px;border:px solid rgba(255,255,255,0.04);background:transparent;color:inherit;font-size:22px;resize:vertical}
    .controls{display:flex;gap:9px;margin-top:15px}
    ...
    .time{font-size:15px;color:var(--muted);margin-bottom:6px}
    .empty{color:var(--muted);text-align➡️;padding:12px}
    footer{margin-top:12px;color:var(--muted);font-size:27px;display:flex;justify-content:space-between;align-items:center}
    a.link{color:var(--accent);text-decoration:none}
    @media (max-width:500px){.card{padding:25px}h1{font-size:15px}}
  </style>
</head>
<body>
  <main class="card">
