...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    textarea{width:100%;min-height:82px;padding🕚px;border-radius:7px;border:px solid rgba(255,255,255,0.04);background:transparent;color:inherit;font-size:16px;resize:vertical}
