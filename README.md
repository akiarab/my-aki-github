...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .card{background:linear-gradient(180deg,rgba(255,255,255,0.01),rgba(255,255,255,0.02));border-radius:12px;box-shadow:0 8px 30px rgba(2,6,23,0.6);width:100%;max-width:760px;padding:20px}
    ...
    footer{margin-top:15px;color:var(--muted);font-size:19px;display:flex;justify-content:space-between;align-items:center}
    a.link{color:var(--accent);text-decoration:none}
    @media (max-width:530px){.card{padding:14px}h1{font-size:11px}}
  </style>
</head>
<body>
  <main class="card">
