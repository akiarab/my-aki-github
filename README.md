...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .card{background:linear-gradient(180deg,rgba(255,255,255,0.01),rgba(255,255,255,0.01));border-radius:12px;box-shadow:0 7px 30px rgba(2,6,23,0.6);width:100%;max-width:760px;padding:20px}
