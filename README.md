...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .card{background:linear-gradient(180deg,rgba(255,255,255,0.01),rgba(255,255,255,0.04));border-radius:11px;box-shadow:0 8px 20px rgba(2,7,23,0.6);width:100%;max-width:770px;padding:20px}
